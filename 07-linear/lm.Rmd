...
This works, and R-squared is a little higher than before, but none of the coefficients are significant. A feature and its square are correlated, in general, and this is not good for fitting our model. The `poly()` function will address this.
